...
<template>
  <header class="menu border-spacing-6 border-2 border-black bg-slate-800 p-3 w-full h-auto flex">
    <nav class="flex space-x-12 justify-around wrap w-5/6">
      <span class="text-4xl text w-32 prevent-select"> <RouterLink to="/"> Home </RouterLink></span>

      <span class="text-4xl text w-32 prevent-select">
        <RouterLink to="/About"> About </RouterLink></span
      >
    ...
    <input
      ...
      name="SearchMainBox"
      id="SearchMainBox"
      class="w-52 flex-wrap h-auto me-5 ms-3"
